...
#include "rosbot_interfaces/msg/detail/obstacle_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, shape
#include "rosidl_runtime_c/string_functions.h"  // name, shape
...
using _ObstacleInfo__ros_msg_type = rosbot_interfaces__msg__ObstacleInfo;
...
size_t get_serialized_size_rosbot_interfaces__msg__ObstacleInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObstacleInfo__ros_msg_type * ros_message = static_cast<const _ObstacleInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObstacleInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbot_interfaces__msg__ObstacleInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbot_interfaces
size_t max_serialized_size_rosbot_interfaces__msg__ObstacleInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ObstacleInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbot_interfaces__msg__ObstacleInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbot_interfaces, msg, ObstacleInfo)() {
