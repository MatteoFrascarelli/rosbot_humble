...
bool rosbot_interfaces__msg__obstacle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbot_interfaces.msg._obstacle_info.ObstacleInfo", full_classname_dest, 49) == 0);
  }
  rosbot_interfaces__msg__ObstacleInfo * ros_message = _ros_message;
  {  // name
  ...
  {  // position
    ...
    if (!geometry_msgs__msg__pose2_d__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // area
    ...
    ros_message->area = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * rosbot_interfaces__msg__obstacle_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosbot_interfaces.msg._obstacle_info");
  ...
  {  // position
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose2_d__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
