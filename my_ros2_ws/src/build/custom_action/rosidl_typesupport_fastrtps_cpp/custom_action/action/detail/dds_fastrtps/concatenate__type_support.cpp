...
{
bool cdr_serialize(
  const custom_action::action::Concatenate_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_action::action::Concatenate_Goal &);
size_t get_serialized_size(
  const custom_action::action::Concatenate_Goal &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const custom_action::action::Concatenate_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_action::action::Concatenate_Result &);
size_t get_serialized_size(
  const custom_action::action::Concatenate_Result &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const custom_action::action::Concatenate_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_action::action::Concatenate_Feedback &);
size_t get_serialized_size(
  const custom_action::action::Concatenate_Feedback &,
  size_t current_alignment);
size_t
