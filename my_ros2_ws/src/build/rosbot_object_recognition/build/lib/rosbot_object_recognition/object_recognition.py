...
def shape_recognition(img):
    ...
    for i, contour in enumerate(contours):
        ...
        print("The frame_ID is: Cartesian coordinates Top-Left", "\n")
...
def main(args=None):
    ...
    # Check if the image has been modified and call the object recognition algorithm
    #image_path = '/home/nuctella/my_ros2_ws/src/rosbot_object_recognition/rosbot_object_recognition/object_recognition/map.png'
    #image_path = '/home/pierocampitelli/init/my_ros2_ws/src/rosbot_object_recognition/rosbot_object_recognition/map.png'
    
    
    """
    last_modified = os.path.getmtime(image_path)
    if last_modified != os.path.getmtime(__file__):
        img = cv2.imread(image_path)
        shape_recognition(img)

    # Update the current modification date of the file
    current_modified = os.path.getmtime(__file__)
    os.utime(image_path, (current_modified, current_modified))
    """
    #Constructor and destructor of the node
    img = cv2.imread('/home/nuctella/my_ros2_ws/map.png')
    shape_recognition(img)
